      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground text-sm max-w-sm mb-6">
              Connectez-vous avec des personnes qui partagent vos passions, près de chez vous. Une nouvelle façon de créer des liens locaux.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li><a href="#" className="hover:text-foreground transition-colors">Communautés</a></li>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © 2024 LocalHash. Tous droits réservés.
          </p>
